...
var incompleteTaskHolder=document.querySelector(".active-tasks");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add("task-item", "task-list__item");
    //input (checkbox)
    ...
    editButton.classList.add("task__item-btn", "btn-edit");
    //button.delete
    ...
    deleteButton.classList.add("task__item-btn", "btn-delete");
    deleteButtonImg.src='./remove.svg';
    deleteButtonImg.classList.add("btn-delete__icon");
